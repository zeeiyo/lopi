...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/zeeiyo/sukasuka",
)
UPSTREAM_BRANCH = getenv("UPSTREAM_BRANCH", "suka")

# GIT TOKEN ( if your edited repo is private)
GIT_TOKEN = getenv("GIT_TOKEN", "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")

# Only  Links formats are  accepted for this Var value.
SUPPORT_CHANNEL = getenv(
    "SUPPORT_CHANNEL", "https://t.me/ZeeYeonho"
...
AUTO_SUGGESTION_TIME = int(
    getenv("AUTO_SUGGESTION_TIME", "50000")
)  # Remember to give value in Seconds
...
TG_AUDIO_FILESIZE_LIMIT = int(
    getenv("TG_AUDIO_FILESIZE_LIMIT", "209715200")
)  # Remember to give value in bytes

TG_VIDEO_FILESIZE_LIMIT = int(
    getenv("TG_VIDEO_FILESIZE_LIMIT", "271338584")
)  # Remember to give value in bytes
